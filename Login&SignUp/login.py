...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Prathmesh\.vscode\GIT\Python-FYP-Face-Recognition-Attendence-System\Images_GUI\loginBg1.jpg")
        ...
        img1=Image.open(r"C:\Users\Prathmesh\.vscode\GIT\Python-FYP-Face-Recognition-Attendence-System\Images_GUI\log1.png")
...
# =====================Forget window=========================================
    def forget_pwd(self):
        if self.txtuser.get()=="":
            ...
            conn = mysql.connector.connect(username='root', password='Pratham#2004',host='localhost',database='face_recognition',port=3306)
            mycursor = conn.cursor()
